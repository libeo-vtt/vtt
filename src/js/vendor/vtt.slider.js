/**
 * Slider
 * app.setComponent('Sliders', 'Slider', $('.slider'));
 */
(function($, window, document, undefined) {

    var root = 'slider';

    function Slider(obj, config, app) {
        ...
        // Set the "slider" or the main container
        this.slider = $(obj);
    ...
    if (window.VTT) {
        VTT.extendComponents(Slider, root.charAt(0).toUpperCase() + root.slice(1));
    } else {
            ...
            if (typeof config === 'string') {
                ...
                return this.each(function() {
                    if (!$.data(this, 'plugin_' + root)) {
                        $.data(this, 'plugin_' + root, new Slider(this, config));
                    }
                });
            }
        };
